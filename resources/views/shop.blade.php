...
<html class="no-js" lang="en">
  ...
  <body>
    ...
    <section class="shopPageSection">
      <div class="container">
        ...
        <div class="row shopProductRow">
          <div class="col-lg-12">
            <div
              class="tab-content productViewTabContent"
                ...
                <div class="row">
                  <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="productItem01">
                      <div class="pi01Thumb">
                        ...
                        <img
                          src="images/products/5.1.jpg"
                          alt="Ulina Product"
                        />
                        <div class="pi01Actions">
                          <a href="javascript:void(0);" class="pi01Cart"
                            ><i class="fa-solid fa-shopping-cart"></i
                          ></a>
                          <a href="javascript:void(0);" class="pi01QuickView"
                            ><i
                              class="fa-solid fa-arrows-up-down-left-right"
                            ></i
                          ></a>
                          <a href="javascript:void(0);" class="pi01Wishlist"
                  ...
                  <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="productItem01">
                      ...
                      <div class="pi01Details">
                        ...
                        <h3>
                          <a href="shop_details2.html"
                            >Men’s black stylish half shirt</a
                          >
                        </h3>
                        <div class="pi01Price">
                          <ins>$129</ins>
                  ...
                  <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="productItem01">
                      ...
                      <div class="pi01Details">
                        ...
                        <h3>
                          <a href="shop_details2.html"
                            >Polyester silk blazer suit for men</a
                          >
                        </h3>
                        <div class="pi01Price">
                          <ins>$499</ins>
                  ...
                  <div class="col-sm-6 col-lg-4 col-xl-3">
                    <div class="productItem01 pi01NoRating">
                      ...
                      <div class="pi01Details">
                        <h3>
                          <a href="shop_details2.html">Apple white jacket</a>
                        </h3>
                        <div class="pi01Price">
                          <ins>$39</ins>
                          <del>$57</del>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 col-xl-6">
                    <div class="productItem02">
                      ...
                      <div class="pi02Details">
                        <h3>
                          <a href="shop_details1.html">Ulina bag for women</a>
                        </h3>
                        <div class="pi01Price">
                          <ins>$49</ins>
                          <del>$60</del>
        ...
        <div class="row shopPaginationRow">
          <div class="col-lg-12 text-center">
            <a href="javascript:void(0);" class="ulinaBTN2 shopLoadMore"
              >Load More</a
            >
          </div>
        </div>
    ...
    <section class="siteInfoSection">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="siteInfo">
              All rights reserved &nbsp;<a href="index.html">Ulina</a
              >&nbsp;&nbsp;&copy;&nbsp;&nbsp;2022
            </div>
          </div>
          <div class="col-md-6">
    ...
    <div
      ...
      id="productQuickView"
      tabindex="-1"
      data-aria-labelledby="exampleModalLabel"
      aria-modal="true"
      role="dialog"
    >
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="productGalleryWrap">
                  <div class="productGalleryPopup">
                    <div class="pgImage">
                      <img
                        src="images/product_details/p1.jpg"
                        alt="Product Image"
                      />
                    </div>
                    <div class="pgImage">
                      <img
                        src="images/product_details/p2.jpg"
                        alt="Product Image"
                      />
                    </div>
                    <div class="pgImage">
                      <img
                        src="images/product_details/p3.jpg"
                        alt="Product Image"
                      />
                    </div>
                    <div class="pgImage">
                      <img
                        src="images/product_details/p4.jpg"
                        alt="Product Image"
                      />
                    </div>
                    <div class="pgImage">
                      <img
                        src="images/product_details/p5.jpg"
                        alt="Product Image"
                      />
                    </div>
                  </div>
                  <div class="productGalleryThumbWrap">
                    <div class="productGalleryThumbPopup">
                      <div class="pgtImage">
                        <img
                          src="images/product_details/t1.jpg"
                          alt="Product Image"
                        />
                      </div>
                      <div class="pgtImage">
                        <img
                          src="images/product_details/t2.jpg"
                          alt="Product Image"
                        />
                      </div>
                      <div class="pgtImage">
                        <img
                          src="images/product_details/t3.jpg"
                          alt="Product Image"
                        />
                      </div>
                      <div class="pgtImage">
                        <img
                          src="images/product_details/t4.jpg"
                          alt="Product Image"
                        />
                      </div>
                      <div class="pgtImage">
                        <img
                          src="images/product_details/t5.jpg"
                          alt="Product Image"
                        />
                      </div>
                    </div>
              ...
              <div class="col-lg-6">
                <div class="productContent">
                  ...
                  <h2>
                    <a href="shop_details1.html"
                      >Ulina luxurious shirt for men</a
                    >
                  </h2>
                  <div class="pi01Price">
                    <ins>$108</ins>
