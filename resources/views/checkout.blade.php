                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="shippingAddress">
                                    <input type="checkbox" value="1" name="field13"
                                        id="shipDifferentAddress" />
                                    <label for="shipDifferentAddress">Ship to Different Address ?</label>
                                </div>
                            </div>
                            <div class="col-lg-12">
                    ...
                    <div class="shippingCoupons">
                        ...
                        <div class="couponFormWrap clearfix">
                            <input type="text" name="coupon_code" class="input-text" id="coupon_code"
                                value="" placeholder="Write your Coupon Code" />
                            <button type="submit" class="ulinaBTN" name="apply_coupon" value="Apply Code">
                        ...
                        <div class="orderReview">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="javascript:void(0);">Ulina casual shirt for men</a>
                                        </td>
                                        <td>
                                            <div class="pi01Price">
                                                <ins>$99.00</ins>
                            ...
                            <ul class="wc_payment_methods">
                                <li class="active">
                                    <input type="radio" checked="" value="1" name="paymentMethod"
                                        id="paymentMethod01" />
